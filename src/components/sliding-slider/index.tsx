...
import { SlidingSliderProps } from "../__generated__/types";
import styles from "./style.module.css";
import "slick-carousel/slick/slick.css";
import "slick-carousel/slick/slick-theme.css";
import { Image, Link } from "@ikas/storefront";

const SlidingSlider = (props: SlidingSliderProps) => {
  const { imageSliders, titleBanner } = props;
        ...
        {slides.length > 0 && (
          <Slider {...settings}>
            {slides.map((slide) => {
              ...
              return (
                <div key={slide.imageSlider.id} className={styles.mobileSlide}>
                  <img
                    alt={alt}
                    height={769}
                    width={1500}
